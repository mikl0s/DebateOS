"""
contract.py — Input contract loaders for DebateOS translators (foundation-neutral).
...
Source: Verbatim from translators/arch/contract.py — foundation-neutral, no
Arch-specific code. Both the Arch and Debian translators import from here.
"""
