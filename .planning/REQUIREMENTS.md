...
- [ ] **RSLV-03**: Ordering constraints feed a topological sort producing the concrete install order; cycles are a hard composition-time error naming the offending opinions
